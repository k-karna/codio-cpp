...
Using the same CelestialBody class, write a class function CloserToSun that compares 
two CelectialBody objects and returns the name of the object that is closer to the sun (smaller distance).
*/
