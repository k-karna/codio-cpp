/*
Exercise 2
Create an enum called seasons that contains four variables: winter, spring, summer, and fall. 
Set up the enum variables so the code in main will print the expected output below.
*/
#include <iostream>
using namespace std;
